        ...
        {posts.map((post, index) => {
          ...
          return (
            <motion.div 
              ...
              key={post.id} 
              className="bg-black/40 backdrop-blur-md border border-white/10 shadow-2xl hover:border-apf-purple/40 hover:shadow-[0_0_15px_rgba(148,0,255,0.3)] transition-all duration-500 overflow-hidden group"
            >
              {featuredMedia && (
