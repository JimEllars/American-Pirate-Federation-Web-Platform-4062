        ...
        {toasts.map((toast) => {
          ...
          return (
            <motion.div
              ...
              className={`bg-black/80 backdrop-blur-md border font-vt323 text-sm tracking-widest px-4 py-3 shadow-[0_0_15px_rgba(0,0,0,0.5)] pointer-events-auto ${borderColor} ${textColor}`}
            >
              {toast.message}
            </motion.div>
          );
