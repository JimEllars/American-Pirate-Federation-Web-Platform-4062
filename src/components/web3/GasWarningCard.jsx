...
export function GasWarningCard({ ethBalance, onDismiss }) {
  ...
  return (
    <div className="bg-black/60 backdrop-blur-2xl border border-white/5 shadow-2xl p-6 hover:border-apf-purple/40 transition-all duration-500 relative overflow-hidden">
