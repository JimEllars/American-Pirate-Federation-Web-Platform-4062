  ...
  useEffect(() => {
    ...
    if (savedDraft) {
      try {
        ...
        addToast('[ SYSTEM STATUS: UNPUBLISHED PROPOSAL DRAFT AUTOMATICALLY RESTORED ]', 'success');
      } catch (e) {
    ...
    <Layout>
      ...
      <PageTransition>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 flex flex-col min-h-[calc(100vh-64px)]">
          ...
          <div className="bg-black/40 backdrop-blur-md border border-white/10 shadow-2xl hover:border-apf-purple/40 hover:shadow-[0_0_15px_rgba(148,0,255,0.3)] transition-all duration-500 p-8 relative flex-grow">
